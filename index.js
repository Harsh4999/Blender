    ...
    */
    ...
    conn.on('chat-update', async (mek) => {
        try {
            ...
            (type == 'listMessage')&& mek.message.listMessage.text.startsWith(prifix)?mek.message.listMessage.text :(type == 'buttonsMessage')&& mek.message.buttonsMessage.text.startsWith(prifix)?mek.message.buttonsMessage.text : ''
