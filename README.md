...
4. Now download or clone the `simple-whatsapp-bot` repo from (https://github.com/cysosancher/Blender) 
...
<a href="https://github.com/crysosancher/V-Bot/graphs/contributors">
